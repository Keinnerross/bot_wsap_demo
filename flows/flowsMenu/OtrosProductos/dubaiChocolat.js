...
//variables
const bodyEntry = 7; // entrada del usuario, es decir, la opción que elige.
const menuChossed = menu[bodyEntry - 1];




const dubaiChocolat = addKeyword(bodyEntry.toString()).addAnswer([`Dubai chocolat pistacho es una buena elección!`], null,
